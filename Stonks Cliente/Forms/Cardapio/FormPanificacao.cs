...
{
    public partial class FormPanificacao : Form
    {
        ...
        public FormPanificacao()
        {
            ...
            Listar(listaProdutos.GetListPanificacao());
        }
        ...
        private void btnAddCarrinho_Click_1(object sender, EventArgs e)
        {
            ...
            {
                foreach (var produto in listaProdutos.GetListPanificacao())
                {
