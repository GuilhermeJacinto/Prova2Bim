...
{
    public partial class FormBebidaGelada : Form
    {
        ...
        public FormBebidaGelada()
        {
            ...
            Listar(listaProdutos.GetListBebidaGeladas());
        }
        ...
        private void btnAddCarrinho_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (var produto in listaProdutos.GetListBebidaGeladas())
                {
